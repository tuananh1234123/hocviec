                            ...
                            <li>
                                <div class="prog-row">
                                    <div class="user-thumb">
                                        <a href="#"><img src="{{ asset('admin') }}/images/avatar1_small.jpg" alt=""></a>
                                    </div>
                                ...
                                <div class="prog-row">
                                    <div class="user-thumb">
                                        <a href="#"><img src="{{ asset('admin') }}/images/avatar1.jpg" alt=""></a>
                                    </div>
                                    <div class="user-details">
                                ...
                                <div class="prog-row">
                                    <div class="user-thumb">
                                        <a href="#"><img src="{{ asset('admin') }}/images/chat-avatar2.jpg" alt=""></a>
                                    </div>
                                    <div class="user-details">
